...
import {
  faBug, faCheck, faCheckSquare,
  faChevronDown,
  faChevronLeft,
  faChevronRight,
  faChevronUp, faCode,
  faCoffee, faCog, faCross, faFileAlt, faGlobe, faHandPeace, faLink, faPencilAlt,
  faPlus, faSquare, faStar, faTimes, faTrash, faTrashAlt, faWindowMaximize, faWindowMinimize, faWindowRestore,
